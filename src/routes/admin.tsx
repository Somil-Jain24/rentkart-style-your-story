      ...
      <header className="border-b border-border bg-card sticky top-0 z-40">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 lg:px-8">
          <div className="flex items-center gap-3">
            <Link to="/" className="hover:opacity-75"><Logo /></Link>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          ...
          <section className="rounded-2xl border border-border bg-card">
            ...
            <div className="border-t border-border p-3">
              <button className="w-full text-xs font-semibold text-primary hover:text-primary-deep">View all 14 pending approvals →</button>
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-border bg-card">
            ...
            <div className="border-t border-border p-3">
              <button className="w-full text-xs font-semibold text-primary hover:text-primary-deep">View all 6 pending reviews →</button>
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-border bg-card">
            ...
            <div className="border-t border-border p-3">
              <button className="w-full text-xs font-semibold text-primary hover:text-primary-deep">View all 3 open disputes →</button>
            </div>
          </section>
        </div>
