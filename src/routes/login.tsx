...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — The RentVerse" }] }),
  component: Login,
});
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto grid w-full max-w-md gap-6 px-4 py-8 lg:py-16">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sign in to continue your The RentVerse journey.</p>
        </div>
        ...
        <div className="rounded-xl border border-dashed border-border p-4">
          <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">New to The RentVerse?</p>
